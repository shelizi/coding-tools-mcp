...
impl MirrorGuard {
    fn create(workspace_root: &Path) -> Result<Self, WorkspaceError> {
...
fn format_json_file(path: &Path) -> Result<(), WorkspaceError> {
...
fn snapshot_tree(root: &Path) -> Result<BTreeMap<String, String>, WorkspaceError> {
